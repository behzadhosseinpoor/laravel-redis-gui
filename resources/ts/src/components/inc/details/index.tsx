...
const Details = () => {
  ...
  return (
    <>
      {details && (
        <div className="flex flex-wrap items-stretch justify-center lg:justify-start">
          {/* Redis version */}
          <div className="inline-flex items-center">
            <SiRedis className="text-xl text-white mr-2" />

            <span className="font-medium">{details.redis_version}</span>
          </div>
          ...
          <div className="inline-flex items-center">
            ...
            <span className="font-medium">{details.connected_clients}</span>
          </div>
        </div>
      )}
    </>
